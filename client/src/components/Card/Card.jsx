    ...
    <div class="container">
      <div className="row g-3">
        <div className="col-12 col-md-6 col-lg-4">
          <div className="card">
            <img src={fairSwing_card} alt="" class="card-img-top"/>
        ...
        <div className="col-12 col-md-6 col-lg-4">
          <div className="card">
            <img src={Rollercoster_card} alt="" class="card-img-top"/>
            <div className="card-body">
        ...
        <div className="col-12 col-md-6 col-lg-4">
          <div className="card">
            <img src={droptower_card} alt="" class="card-img-top"/>
            <div className="card-body">
        ...
        <div className="col-12 col-md-6 col-lg-4">
          <div className="card">
            <img src={ferriswheel_card} alt="" class="card-img-top"/>
            <div className="card-body">
        ...
        <div className="col-12 col-md-6 col-lg-4">
          <div className="card">
            <img src={bumpercar_card} alt="" class="card-img-top"/>
            <div className="card-body">
        ...
        <div className="col-12 col-md-6 col-lg-4">
          <div className="card">
            <img src={waterpark_card} alt="" class="card-img-top"/>
            <div className="card-body">
