...
const Rides = () => {
    ...
    const [selectedPackage, setSelectedPackage] = useState(null); // For storing selected package data

    const navigate = useNavigate();

    const Submit = (e) => {
        e.preventDefault();
        const RidePackageData = { RideName, Price };

        axios.post('http://localhost:4500/AddRide', RidePackageData)
            .then(result => {
                console.log(result);
    ...
    useEffect(() => {
        ...
        axios.get('http://localhost:4500/AddPackage')
            .then(result => {
    ...
    const handleEditSubmit = (e) => {
        e.preventDefault();
        const updatedPackage = { RideName, Price };
        axios.put(`http://localhost:4500/EditRide/${selectedPackage._id}`, updatedPackage)
            .then(result => {
                console.log(result);
                handleClose();
                            ...
                            <form onSubmit={Submit}>
                                <div className="row g-4 form">
                                    ...
                                    <div className="col-lg-6 col-md-6">
                                        ...
                                        <input type="file" className="form-control border-primary p-2"  onChange={(e) => setRideImage(e.target.value)} />
                                    </div>
                                    <div className="col-lg-6 col-md-6">
                ...
                <Modal.Body>
                    <form onSubmit={handleEditSubmit}>
                        ...
                        <div className="col-lg-4 col-md-6">
                            ...
                            <div className="col-lg-6 col-md-6">
                                <label>Package Name</label>
                                <input type="text" className="form-control border-primary p-2" onChange={(e) => setRideName(e.target.value)} />
                            </div>
                            <div className="col-lg-6 col-md-6">
                                <label>Package Name</label>
